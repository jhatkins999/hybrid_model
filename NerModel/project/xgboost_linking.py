...
def main():
    train_sgtb_path = os.path.abspath(os.path.join("project", "data", "output", "sgtb_train_scores.json"))
    dev_sgtb_path = os.path.abspath(os.path.join("project","data", "output", "sgtb_dev_scores.json"))
    test_sgtb_path = os.path.abspath(os.path.join("project","data", "output", "sgtb_test_scores.json"))
    ...
    print(test_pred_threshold)
    print(test_dataset[1])
    print("precision:",precision_score(test_dataset[1], test_pred_threshold))
    print("recall:",recall_score(test_dataset[1], test_pred_threshold))
    print("f1:",f1_score(test_dataset[1], test_pred_threshold))
