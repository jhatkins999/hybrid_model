    ...
    with open(new_split_path, "w") as new_split_fp,\
        ...
        for paper in new_papers:
            ...
            #   raise Exception("Paper {} was not found in old train, dev, or test".format(paper))
                print("Paper {} was not found in old train, dev, or test".format(paper))
                continue
...
def main():
    old_data_path = os.path.abspath(os.path.join("data"))
    ...
    new_splits_base_path = os.path.abspath(os.path.join("data.new"))
